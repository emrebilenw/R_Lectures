              ...
              <div className="col-sm-6">
                <div className="">
                  <div className="card-body">
                    <h5 className="card-title ml-2 myTextAbout4" style={{fontSize:"30px"}}>Benimle çalışmak ister misin? 🤝</h5>
                    <p className="card-text myTextAbout123"> &nbsp; Merhaba! Ben Emre, bu platformda sizinle çalışmaktan ve size değerli
              ...
              <div className="col-sm-6">
                <div className="">
                  <div className="card-body">
                    ...
                    <h5 className="card-title ml-2 myTextAbout4" style={{fontSize:"30px"}}>Görüşlerin benim için çok değeri. ✍️</h5>
                    <p className="card-text myTextAbout123"> &nbsp; Sitemi ziyaret ettiğiniz için teşekkür ederim! Sizinle etkileşimde
