...
<div className='row'>
  <div className='col-1'></div>
          <div class="jumbotron mt-5 col-10 boxShadow2" >
           <h1 class="display-4 myTextAbout4">Ben Kimim?</h1>
            <p class="lead myTextAbout3">
            ...
            <button className="btn myTextAbout5 text-white" onClick={this.handleDownload} style={{borderRadius:"20px",backgroundColor:"#00488b" }}>İndir</button>
                    ...
                    <div className='row'> 
                      <div className='col-1'></div>
                      <ul class="list-unstyled ml-0 pl-0 col-10">
                <li class="media ml-1">
                <i class="fa-brands fa-youtube fa-2x"></i>
                  <div class="media-body">
                    <h5 class="mt-0 mb-1 ml-2 myTextAbout2">YouTube</h5>
                    <p className='ml-2 myTextAbout'>Eğitim programımın önemli videolarına youtube kanalımdan ulaşabilirsiniz!</p>
                  </div>
                </li>
                <li class="media my-4 ml-1">
                <i class="fa-brands fa-tiktok fa-2x"></i>
                  <div class="media-body">
                    <h5 class="mt-0 mb-1 ml-3 myTextAbout2">TikTok</h5>
                ...
                <i class="fa-brands fa-instagram fa-2x"></i>
                  <div class="media-body">
                    <h5 class="mt-0 mb-1 ml-3 myTextAbout2">Instragram</h5>
